...
class QueryParam:
    ...
    level: int = 2
    top_k: int = 100  # MASSIVE RETRIEVAL for ontological coverage (was 20)
    ...
    # local search
    local_max_hops: int = 5  # Deep multi-hop for "small worlds" reconstitution (high probability of completeness)
    local_max_token_for_text_unit: int = 12000  # INCREASED for complete small worlds (was 4000)
    local_max_token_for_local_context: int = 16000  # INCREASED for ontological completeness (was 4800)
    local_max_token_for_community_report: int = 8000  # INCREASED for thematic coverage (was 3200)
